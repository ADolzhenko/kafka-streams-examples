 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha3-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha3-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
