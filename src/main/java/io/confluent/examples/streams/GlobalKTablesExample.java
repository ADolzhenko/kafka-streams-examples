 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha3-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha3-standalone.jar io.confluent.examples.streams.GlobalKTablesExampleDriver
 * }
 * </pre>
 * <p>
